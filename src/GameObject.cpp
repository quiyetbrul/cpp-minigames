...
GameObject::GameObject(int playerChoice, int computerChoice, int playerScore, int computerScore)
{
...
int GameObject::getPlayerChoice()
{
    return playerChoice;
}

int GameObject::getComputerChoice()
{
...
int GameObject::getPlayerScore()
{
    return playerScore;
}

int GameObject::getComputerScore()
{
